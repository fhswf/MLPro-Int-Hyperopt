...
class myPolicy(Policy):
    ...
    def __init__(self, p_observation_space: MSpace, p_action_space: MSpace, p_buffer_size=1, p_ada=True,
        ...
        """
        super().__init__(p_observation_space=p_observation_space, p_action_space=p_action_space,
                         p_buffer_size=p_buffer_size, p_ada=p_ada, p_logging=p_logging)
...
class BGLP_Rnd(RLScenario):
    ...
    def _setup(self, p_mode, p_ada: bool, p_visualize: bool, p_logging) -> Model:
        ...
        _policy = myPolicy(p_observation_space=_ospace, p_action_space=_aspace, p_buffer_size=1, p_ada=1,
